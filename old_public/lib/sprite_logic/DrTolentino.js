...
var DrTolentino = function (_Character) {
  _inherits(DrTolentino, _Character);

  function DrTolentino(game, spritesheet, playerNumber, assets, name) {
    _classCallCheck(this, DrTolentino);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(DrTolentino).call(this, game, spritesheet, playerNumber, assets, name));

    _this.loadAnims();
    return _this;
  }

  _createClass(DrTolentino, [{
    key: "loadAnims",
