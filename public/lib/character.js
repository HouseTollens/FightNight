...
var Character = function () {
  ...
  _createClass(Character, [{
    ...
    value: function setOpponent(opponent) {
      ...
      if (this.opponent.name === "DrChinn" || this.opponent.name === "DrTolentino") this.damage = 1;else if (this.opponent.name === "Jon") this.damage = .8;else this.damage = .6;
    }
  }, {
    key: "draw",
    value: function draw() {
    ...
    key: "updatePlayerOne",
    value: function updatePlayerOne() {
      if (this.game.w && !this.isJumping && !this.isFalling) {
        ...
        if (this.x < this.canvasWidth - 370 && !this.collide(this.opponent)) {
          //keeps jon from walking off the right of the screen. Could someone add a correct width statement of Nick?
          this.walkingRight = true;
          this.x += 15;
        }
      } else if (this.game.a) {
        if (this.x > 0) {
          //keeps jon from walking out the left of the screen
    ...
    key: "updatePlayerTwo",
    value: function updatePlayerTwo() {
    ...
    key: "playGettingPunched",
    value: function playGettingPunched() {
    ...
    key: "playGettingKicked",
    value: function playGettingKicked() {
    ...
    key: "hitMeScotty",
    value: function hitMeScotty(damage) {
    ...
    key: "isMyOpponentReallyHittingMe",
    value: function isMyOpponentReallyHittingMe() {

      return !(this.isBlocking || this.isCrouching || this.isHoldingBlock || this.isHoldingCrouch || this.isJumping || this.isFalling);
    }
  }, {
    key: "amIhittable",
    value: function amIhittable() {
